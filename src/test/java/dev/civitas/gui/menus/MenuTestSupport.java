...
final class MenuTestSupport implements AutoCloseable {
    ...
    private MenuTestSupport(Path directory, Plugin plugin) {
        ...
        this.services = new CivitasServices(cities.registry, cities.cities, cities.ranks,
                ...
                new dev.civitas.core.economy.CircuitBreakerService(cities.daos,
                        new dev.civitas.core.economy.MoneySupplyService(cities.daos,
                                cities.economy, cities.treasury, cities.configs,
                                CityTestSupport.quietLogger()),
                        cities.configs, CityTestSupport.quietLogger()),
                ...
                new dev.civitas.core.waystation.WaystationService(cities.db, cities.daos,
                        ...
                        cities.configs, dev.civitas.util.Scheduler.direct()),
                cities.shops, quests,
                new dev.civitas.core.onboarding.OnboardingService(cities.daos.onboarding(),
                        cities.economy, cities.configs, CityTestSupport.quietLogger()),
                challenges, leaderboards,
                new dev.civitas.core.season.SeasonService(cities.daos.seasons(),
                        leaderboards, cities.configs, CityTestSupport.quietLogger()),
                stats,
